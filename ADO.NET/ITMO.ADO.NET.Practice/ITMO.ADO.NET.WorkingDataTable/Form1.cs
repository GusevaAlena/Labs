...
namespace ITMO.ADO.NET.WorkingDataTable
{
    public partial class Form1 : Form
    {
        ...
        {
            String SelectedCustomersID = CustomersDataGridView.CurrentRow.Cells["CustomerID"].Value.ToString();
            NorthwindDataSet.CustomersRow SelectedRow = northwindDataSet1.Customers.FindByCustomerID(SelectedCustomersID);
            return SelectedRow;
        }
