...
namespace ITMO.ADO.NET.DBConnection
{
    public partial class Form1 : Form
    {
        ...
        private void connection_StateChange(object sender, StateChangeEventArgs e)
        {
            ...
            аToolStripMenuItem.Enabled = (e.CurrentState == ConnectionState.Closed);
       ...
       // Initial Catalog=Northwind; Integrated Security=true";
        ...
        private async void аToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (connection.State != ConnectionState.Open)
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try 
            {
                int number = WorkWithDataBase.ExecuteScalarMethod(connectionString,
