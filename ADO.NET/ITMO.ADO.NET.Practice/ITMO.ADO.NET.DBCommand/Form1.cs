...
namespace ITMO.ADO.NET.DBCommand
{
    public partial class Form1 : Form
    {
        ...
        private void button2_BQuery_Click(object sender, EventArgs e)
        {
            StringBuilder results = new StringBuilder();
            using (sqlConnection1)
            {
        ...
        private void button3_StProc_Click(object sender, EventArgs e)
        {
            StringBuilder results = new StringBuilder();
            using (sqlConnection1)
            {
        ...
        private void button4_CreateTable_Click(object sender, EventArgs e)
        {
            using (sqlConnection1)
            {
        ...
        private void button5_QueryWithParam_Click(object sender, EventArgs e)
        {
            StringBuilder results = new StringBuilder();
            try 
            {
        ...
        private void button6_StProcParam_Click(object sender, EventArgs e)
        {
            StringBuilder results = new StringBuilder();
            try
            {
